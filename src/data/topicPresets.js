export const topicPresets = [
  ...
  },
  {
    ...
    label: '생활심리/관계지혜',
    description: '무례한 사람, 말투, 거리두기, 자존감, 가족·직장 관계처럼 실전 대처에 가까운 생활형 관계 소재',
    keywords: [
      '무례한 사람 대처법',
      '나를 만만하게 보는 사람',
      '나이 들수록 멀리해야 할 사람',
    ...
    overseasSeeds: {
      en: [
        { q: 'how to deal with rude people', note: '무례한 사람 대처법 원형' },
        { q: 'setting boundaries with family', note: '가족 관계 경계 설정 소재' },
        { q: 'toxic people signs', note: '멀리해야 할 사람 특징 포맷' },
        { q: 'people pleasing', note: '착한 사람/거절 못함 소재' },
        { q: 'assertive communication', note: '무시당하지 않는 말투와 의사표현 소재' },
      ],
      ja: [
        { q: '失礼な人 対処法', note: '무례한 사람 대처법 소재' },
        { q: '人間関係 距離感', note: '관계 거리두기 포맷' },
        { q: '関わってはいけない人 特徴', note: '멀리해야 할 사람 특징 포맷' },
        { q: '断れない人 心理', note: '거절 못하는 사람 심리 소재' },
        { q: '上品な話し方', note: '품격 있는 말투 소재' },
      ],
    },
  },
  {
