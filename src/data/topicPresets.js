export const topicPresets = [
  ...
  },
  {
    ...
    overseasSeeds: {
      en: [
        { q: 'toxic people', note: '피곤한 사람/멀리할 사람 원형' },
        { q: 'healthy boundaries', note: '관계의 선과 거리두기 소재' },
        { q: 'rude people', note: '무례한 사람 소재' },
        { q: 'people pleasing', note: '거절 못함/착한 사람 소재' },
        { q: 'self respect', note: '자존감과 나를 지키는 관계 소재' },
      ],
      ja: [
        { q: '人間関係', note: '인간관계 전반 소재' },
        { q: '距離感', note: '관계 거리두기 소재' },
        { q: '失礼な人', note: '무례한 사람 소재' },
        { q: '断れない人', note: '거절 못하는 사람 소재' },
        { q: '自己肯定感', note: '자존감/마음 지키기 소재' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    label: '근현대 생활사',
    description: '1960~90년대 의식주, 학교, 놀이, 기술, 직업, 도시 변화처럼 향수와 자료성이 같이 있는 생활사 소재',
    keywords: [
      '1970년대 한국',
      '1980년대 한국',
      '옛날 도시락',
